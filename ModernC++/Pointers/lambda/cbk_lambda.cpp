...
#include<functional>
/*
Assignment : Array modifcation using lambda(callback)

* Calculate takes  two parameters first is array, second is a function which
...
{
    auto onEvent = [&send_data_cbk](bool &response)->void { 
